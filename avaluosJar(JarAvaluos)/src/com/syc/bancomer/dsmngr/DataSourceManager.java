package com.syc.bancomer.dsmngr;
...
public abstract class DataSourceManager extends Thread {
	...
	protected void init() {
		if (ds == null) {
			...
			try {
				...
				if ("T".equals(ConfiguracionAval.TIPO_SESION)) {
	...
	public Connection getConnection() throws SQLException {
		...
		if (Integer.toString(ConfiguracionAval.BASE_DATOS).equals(Integer.toString(ConstantesBD.SQL_SERVER))) {
